...
def create_app(test_config=None) -> Flask:
    ...
    mail.init_app(app)
    Migrate(app, db)
    api.add_resource(endpoints.UserLogin, "/user/login")
    api.add_resource(endpoints.UserRegistration, "/user/registration")
    api.add_resource(endpoints.UserActivation, "/user/activate")
    api.add_resource(endpoints.UserResetPassword, "/user/reset_password")
    api.add_resource(endpoints.UserDeletion, "/user/delete")
